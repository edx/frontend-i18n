...
#. The job to pull translations out of Transifex and commit them to your repo will call ``make pull_translations``.
      ...
      * If the languages you want to pull down differ from the default set listed in the ``frontend-i18n`` Makefile, you can set the ``transifex_langs`` variable in your local Makefile, after the include.
